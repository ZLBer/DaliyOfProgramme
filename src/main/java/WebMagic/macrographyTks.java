...
public class macrographyTks implements PageProcessor {
...
//            id++;
    ...
    public static void main(String[] args) {
        ...
        int pageNumber=0;
        Spider.create(new macrographyTks()).addUrl("https://list1.mysteel.com/article/p-401-------------1.html?channelId=401&includeChild=true&page="+pageNumber).thread(5).run();
