  ...
  if(board[click[0]][click[1]]=='M'){
      ...
      return board;
        ...
        while (!queue.isEmpty()){
            ...
            //空白 遍历四个方向
            int countMine=helper(board,point);
            ...
            if(countMine==0) {
                ...
                for (int i = 0; i < direction.length; i++) {
                    ...
                    if (x >= 0 && x < board.length && y >= 0 && y < board[0].length && !visited[x][y] && board[x][y] != 'M') {
                        visited[x][y]=true;
                        queue.offer(new int[]{x, y});
                    }
                }
            }else {
               board[point[0]][point[1]]=(char) (countMine+'0');
            }
        }
return board;
    ...
    int helper(char[][]board,int []point){
        int count=0;
        for (int i = 0; i < direction.length; i++) {
            int x=point[0]+direction[i][0];
            int y=point[1]+direction[i][1];
   ...
   /* public char[][] updateBoard(char[][] board, int[] click) {
    ...
    public static void main(String[] args) {
      ...
      new leet529().updateBoard(board,new int[]{29,2});
    }
}
